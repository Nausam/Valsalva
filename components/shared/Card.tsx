...
{
  /* <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px] border hover:border-blue-200 hover:shadow-blue-200 ">
      <Link
        href={`/product/${product._id}`}
        style={{ backgroundImage: `url(${product.imageUrl})` }}
        className="flex-center flex-grow bg-gray-50 bg-cover bg-center text-grey-500"
